...
export default function FSCScreen({navigation}) {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      getTransactionRecord({page: 1, size: pageSize, currency: 'USDT'})
        .then(result => {
    ...
    return (
      <View style={styles.item}>
        ...
        <InterText
          ...
          {formatBalance(item.amount)} USDT
        </InterText>
      </View>
    );
  };
          ...
          <>
            <LinearGradient
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Image source={usdtToken} style={{height: 24, width: 24}} />
            ...
            <View>
              <View style={styles.actionBar}>
                ...
                <TouchableOpacity
                  style={styles.action}
                  onPress={() =>
                    navigation.navigate('TopUpScreen', {currency: 'USDT'})
                  }>
                ...
                <TouchableOpacity
                  ...
                  <Image source={actionWithdraw} style={{height: 20, width: 20}} />
                  <InterText
                    weight={600}
                    style={{marginLeft: 3, fontSize: 14, color: '#1A2024'}}>
                    {t('wallet.withdraw')}
